  ...
  return (
    ...
    <div className="container p-4 pb-0">
      ...
      <section className="mb-4">
        {/* Facebook */}
        {/* <a href="#!" role="button"><FaFacebook /></a> */}
        {/* Twitter */}
        ...
        {/* Linkedin */}
        {/* <a className="btn btn-primary btn-floating m-1" style={{backgroundColor: '#0082ca'}} href="https://www.linkedin.com/in/ankitnagar09/" role="button"><i className="fab fa-linkedin-in" /></a> */}
        {/* Github */}
        {/* <a className="btn btn-primary btn-floating m-1" style={{backgroundColor: '#333333'}} href="https://github.com/Ankit-op07" role="button"><i className="fab fa-github" /></a> */}
      </section>
      {/* Section: Social media */}
    </div>
    {/* Grid container */}
